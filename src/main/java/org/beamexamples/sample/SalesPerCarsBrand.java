package org.beamexamples.sample;
...
public class SalesPerCarsBrand {
    ...
    public static final void main(String args[]) throws Exception {
        ...
        PCollection<String> input =
                pipeline.apply(TextIO.read().from("/home/harsha/cars_sales_log"));
        ...
        sumUpValuesByKey.apply(TextIO.write().to("/home/harsha/cars_sales_report").withoutSharding());
